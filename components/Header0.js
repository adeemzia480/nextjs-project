  ...
  return (
    <div className={cn(styles.group1, 'header0')}>
      <div className={styles.box}>
        ...
        <Image src={require('assets/23586f801fec4445e67c769affd4e840.png')} alt="alt text" className={styles.image} />
        <Image src={require('assets/23586f801fec4445e67c769affd4e840.png')} alt="alt text" className={styles.image1} />
      </div>
