      ...
      <div className={styles.flexCol}>
        <div className={styles.flexRow}>
          <div className={styles.flexRow__item}>
            <img src={require('assets/371acf7039d52b19d107a79d39ef04f5.png')} alt="alt text" className={styles.icon} />
          </div>
        ...
        <div className={styles.flexRow1}>
          <div className={styles.flexRow1__item}>
            <img src={require('assets/371acf7039d52b19d107a79d39ef04f5.png')} alt="alt text" className={styles.icon1} />
          </div>
        ...
        <div className={styles.flexRow1}>
          <div className={styles.flexRow1__item1}>
            <img src={require('assets/371acf7039d52b19d107a79d39ef04f5.png')} alt="alt text" className={styles.icon2} />
          </div>
        ...
        <div className={styles.flexRow1}>
          <div className={styles.flexRow1__item2}>
            <img src={require('assets/371acf7039d52b19d107a79d39ef04f5.png')} alt="alt text" className={styles.icon3} />
          </div>
