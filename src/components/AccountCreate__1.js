...
import styles from './AccountCreate__1.module.scss';

export default function AccountCreate__1(props) {
  return (
    <React.Fragment>
      ...
      <div className={cn(styles.root, 'account-create-1')}>
...
AccountCreate__1.inStorybook = true;
