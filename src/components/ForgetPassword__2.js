...
import styles from './ForgetPassword__2.module.scss';

export default function ForgetPassword__2(props) {
  return (
    <React.Fragment>
      ...
      <div className={cn(styles.root, 'forget-password-2')}>
...
ForgetPassword__2.inStorybook = true;
