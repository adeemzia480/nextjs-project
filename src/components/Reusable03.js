...
export default function Reusable03(props) {
  return (
    <section className={cn(styles.section4, 'reusable03')}>
      <px-grid x="81fr minmax(0px, max-content) 1020fr" y="49px 69fr 0px">
        <h1 className={styles.hero_title2}>Find Brand Deals</h1>
      </px-grid>

      <div className={styles.grid}>
        <div className={styles.grid__item}>
          <img src={require('assets/633a9053a5e7d1ade00c4cce39ecfa5a.png')} alt="alt text" className={styles.image12} />
        </div>
        <div className={styles.grid__item}>
          <img
        ...
        <div className={styles.grid__item}>
          <div className={styles.box15}>
            <div className={styles.box15__item}>
              <img
